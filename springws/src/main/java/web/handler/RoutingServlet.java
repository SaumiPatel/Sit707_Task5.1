    ...
    public RedirectView q1(
        ...
        if (calculatedResult == null) {
            ...
            if (resultUser != null && !resultUser.isEmpty() && 
                calculatedResult.equals(Double.valueOf(resultUser))) {
    ...
    public RedirectView q3(
        ...
        if (calculatedResult == null) {
            ...
            if (resultUser != null && !resultUser.isEmpty() && 
                ...
                redirectAttributes.addFlashAttribute("message", "Congratulations! You've completed all math questions successfully!");
            } else {
                // Q3 wrong
                redirectView = new RedirectView("/q3", true);
                // Show error message
