...
public class WeatherControllerTest {
	...
	public void testStudentIdentity() {
		...
		String studentId = "s223979728"; // Replace with your actual student ID
	...
	public void testStudentName() {
		...
		String studentName = "Saumil Patel"; // Replace with your actual name
	...
	public void testTemperaturePersist() {
		...
		// Arrange - Create a mock timestamp pattern for validation
		// Instead of comparing actual timestamps which can differ due to delays
		String timestampPattern = "\\d{1,2}:\\d{1,2}:\\d{1,2}"; // HH:mm:ss format
		...
		// Additional assert - verify the timestamp matches the expected format
		// This follows the Fast and Repeatable properties of FIRST principle
		Assert.assertTrue("Persist time should match HH:mm:ss format", 
				persistTime.matches(timestampPattern));
	}
